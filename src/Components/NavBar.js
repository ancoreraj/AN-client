    ...
    return(
        ...
        <div className="brandLogo d-flex justify-content-between">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                <a class="dropdown-item" href="#"><svg xmlns="http://www.w3.org/2000/svg" className='marginRight2' width="16" height="16" fill="#FF7940" class="bi bi-person-circle" viewBox="0 0 16 16">
